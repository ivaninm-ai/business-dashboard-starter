...
import { businessIds, businessProfile, loadScenario, DAYS, dayNumber } from '../../data/scenarios.js';
...
export function renderAbout() {
  ...
  add(root, h('div', { class: 'card' }, t('h2', tr('Limits')),
    h('ul', { class: 'small ink2' },
      ...
      t('li', tr('It reads only the bundled training files. Using other data means changing the project (see docs/STUDENT_SOP.md).')),
